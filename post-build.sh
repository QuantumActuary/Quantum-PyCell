...
if [ ! -d /Applications/Quantum.app/Contents/Resources/.kivy/extensions/plugins ]; then
  mkdir /Applications/Quantum.app/Contents/Resources/.kivy/extensions/plugins
fi;
cp -r ${PY}Plugins/* ${MOD}
cp ${BIN}/${FILE} ${EXT}
{
